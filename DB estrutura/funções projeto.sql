...
begin
	...
	having jogadores_jogos_equipas.id_equipa = 1 and campeonatos___jogos___equipas.id_campeonato = 1 and pontuacoes___jogadores_jogos.status = 'true') as golos_da_equipa);
...
begin
	...
	having pontuacoes___jogadores_jogos.id_jogador = 7 and jogadores_jogos_equipas.id_jogador = 7 and campeonatos___jogos___equipas.id_campeonato = 1 and pontuacoes___jogadores_jogos .status = 'true') as golos);
end;
$$
